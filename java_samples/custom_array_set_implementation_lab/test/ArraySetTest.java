...
public class ArraySetTest {
    ...
    public void testSizeAfterAdd() {
        int numberToAdd = 1;
        testArraySet.add(numberToAdd);
        assertEquals(testArraySet.size(), 1);
    }
    @Test
    public void testSizeAfterSuccessfulRemove() {
        int numberToAdd = 1;
        testArraySet.add(numberToAdd);
        assertEquals(testArraySet.size(), 1);
        testArraySet.remove(numberToAdd);
        assertEquals(testArraySet.size(), 0);
    }
    @Test
    public void testContainsReturnsTrueSmallSetInLargeSet() {
        boolean result = true;
        for (int i = 0; i < LARGE; ++i) {
            testArraySet.add(i);
        }
    ...
    @Test
    public void testRetainAllElementsFromNonemptySetMatching() {
        for (int i = 0; i < SMALL; ++i) {
            testArraySet.add(i);
        }
    ...
    @Test
    public void testAddOneTryToAddSameOne() {
        assertTrue(testArraySet.isEmpty());
        int numberToAdd = 1;
        boolean addResult = testArraySet.add(numberToAdd);
        assertTrue(addResult);
        ...
        addResult = testArraySet.add(numberToAdd);
    ...
    @Test
    public void testToArrayGenericsEmpty() {
