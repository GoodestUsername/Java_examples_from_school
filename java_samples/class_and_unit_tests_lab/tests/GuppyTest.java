...
class GuppyTest {
     ...
     * Test toString.
     *
     * @author Blake Michalzik, Updated generationNumber by Lily
     */
    @Test
    void testToString() {
        // Setup
    ...
    /**
     * Test hashCode is unaffected by generation number.
     *
     * @author Simon Newell
     */
    @Test
    void testHashCodeUnaffectedByGenerationNumber() {
        // Setup
        final Guppy secondGenerationGuppy = new Guppy(Guppy.DEFAULT_GENUS, Guppy.DEFAULT_SPECIES,
                Guppy.MINIMUM_AGE_IN_WEEKS, true, 1, Guppy.DEFAULT_HEALTH_COEFFICIENT);

        final int expected = secondGenerationGuppy.hashCode();
